  ...
  render() {
    return (
      <div id="main">
        ...
        <div id="createemp">Employee Name<sup>*</sup>: <input type="text" id="empnamefirst" placeholder="first name" onChange={this.handleChange.bind(this, "firstname")}/><input type="text" id="empnamelast" placeholder="last name" onChange={this.handleChange.bind(this,
            "lastname")}/><br/><br/> Address:
          <br/>
        </div>
        <div id="address">
          <table id="addr_table">
        ...
        <div id="hobbies">
          ...
          <div id="hobby_checkbox">
            <Hobbies count={this.state.hobbycount} />
          </div>
          <div>
